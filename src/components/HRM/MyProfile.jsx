...
const MyProfile = () => {
//   const { id } = useParams();
  const { employees, loading, error, fetchEmployees, updateEmployee, deleteEmployee, currentEmployee, fetchCurrentEmployee } = useEmployeeStore();
...
//     } else {
//         // fetchEmployees();
//           const foundEmployee = employees.find(emp => emp.id === user.employeeId);
//           setEmployee(foundEmployee);
//     // fetchCurrentEmployee();
//     // setEmployee(currentEmployee);
//     }
//   }, [user, employees, fetchEmployees]);
...
useEffect(() => {
  ...
  }, [user?.employeeId, fetchEmployees]);
  
  // Get employee from store directly instead of local state
  ...
  const handleSaveEmployee = async (employeeData) => {
    try {
      ...
      const updatedEmployee = updatedEmployees.find(emp => emp.id === user.employeeId);
