        ...
        <div className="bg-white p-6 rounded-lg shadow border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">{totalProducts} products</p>
            </div>
          ...
          <div className="space-y-3">
            {salesByPeriod.map((period, index) => (
              <div key={index} className="flex items-center justify-between">
                <span className="text-sm text-gray-600 w-12">{period.label}</span>
                ...
                <div className="text-right w-24">
                  <div className="text-sm font-medium">₹{period.sales.toFixed(2)}</div>
                  <div className="text-xs text-gray-500">{period.count} orders</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow border">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 bg-blue-50 rounded">
              ...
              <span className="font-medium text-blue-600">{activeCustomers.length}</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-purple-50 rounded">
              <span className="text-sm text-purple-600">Avg Loyalty Points</span>
          ...
          <h4 className="text-md font-semibold mt-6 mb-3">Top Loyalty Customers</h4>
